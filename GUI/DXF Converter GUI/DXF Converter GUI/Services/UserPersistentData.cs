...
namespace DXF_Converter_GUI.Services;

/// <summary>
/// Stores and fetches arbitrary key/value data on the user's local machine.<br/>
/// Data is stored at %LOCALAPPDATA%\DXF Converter GUI\{settingsFileNameNoExtension}.json as a JSON
/// object mapping each key to its JSON-serialized value.
/// </summary>
public class UserPersistentData
{
    private const string AppFolderName = "DXF Converter GUI";
    ...
    /// Data is stored at %LOCALAPPDATA%\DXF Converter GUI\<paramref name="settingsFileNameNoExtension"/>.json
    /// </summary>
    public UserPersistentData(string settingsFileNameNoExtension)
    {
        _settingsFilePath = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
            AppFolderName, $"{settingsFileNameNoExtension}.json");
    }
